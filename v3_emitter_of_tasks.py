...
def offer_rabbitmq_admin_site(false):
...
for row in reader:
   ...
   # reading the row in the file with no headers
   input_file.read

   # make sure the f is outside of the quotations
...
if __name__ == "__main__":  
    ...
    message = " ".join(sys.argv[0:]) or "{message}"
    # send the message to the queue
    send_message("localhost","task_queue4",message)